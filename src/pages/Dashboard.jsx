    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-[#0B0F1A] p-4 md:p-10 transition-colors duration-500">
            ...
            <section className="mb-16">
                ...
                {/* 1. CASE: There are companies with urgent deadlines */}
                {companies.length > 0 && urgentCompanies.length > 0 ? (
                    ...
                    /* 2. CASE: There ARE companies, but none are urgent */
                    ...
                    /* 3. CASE: No companies exist at all */
                    <div onClick={() => navigate('/company-settings')} className="p-8 bg-amber-500/5 border-2 border-dashed border-amber-500/20 rounded-[2.5rem] flex flex-col items-center text-center cursor-pointer hover:bg-amber-500/10 transition-all">
                        <div className="w-16 h-16 rounded-full bg-amber-500/20 text-amber-600 flex items-center justify-center text-2xl mb-4">🏢</div>
                        <p className="text-slate-900 dark:text-white font-black uppercase text-sm">No Companies Found</p>
                        <p className="text-slate-500 text-[10px] font-black uppercase tracking-widest mt-1 mb-4">Get started by onboarding your first limited company.</p>
                        <button className="bg-amber-600 text-white px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest">Add Company</button>
                    </div>
                )}
            </section>
