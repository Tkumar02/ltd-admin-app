        ...
        `}
            >
                ...
                <nav className="flex flex-col space-y-3">
                    ...
                    <Link to="/record-expense" className="text-pink-400 hover:text-purple-400">Outgoings</Link>
                    <Link to="info" className="text-blue-400 hover:text-indigo-400">Useful information</Link>
                    ...
                    <Link to="/revenue-history" className="text-purple-400 hover:text-red-400">Revenue</Link>
